...
//	private ImageView bitmap;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		content = (TextView) Rootview.findViewById(R.id.weltenburg_geschichte_content);
		setTypeFaces();
		card = (RelativeLayout) Rootview.findViewById(R.id.weltenburg_geschichte_item);		
//		bitmap = (ImageView) Rootview.findViewById (R.id.weltenburg_geschichte_bitmap);
		p = new Point();
		...
		content.setText(geschichtePoint.getGeschichteDeText());
		if(geschichtePoint.getGeschichteBitmap()!=null){
			Bitmap blurredBackground = (geschichtePoint.getGeschichteBitmap());
			@SuppressWarnings("deprecation")
			BitmapDrawable da = new BitmapDrawable(blurredBackground);
			card.setBackground(da);
			card.getBackground().setAlpha(alphaBackground);
		}//else{
//			bitmap.setVisibility(View.INVISIBLE);
//		}
